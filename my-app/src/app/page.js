    ...
    <div className="w-full meme flex flex-col items-center justify-center">
      ...
      <section className="w-full flex flex-col gap-24 md:gap-40 xl:gap-60 items-center px-6 md:px-12 xl:px-40 py-10 md:py-20 md:pt-28">
        ...
        <div className="w-full blockbox flex items-center bg-[#f9dee4] px-5 py-3 xl:px-20 xl:py-10 relative rounded-lg shadow-lg shadow-[#4d0622]">
          ...
          <div className="w-[35vw] md:max-h-[250px] max-h-[180px] md:h-[30vw] md:w-[30vw] h-[38vw] lg:h-[30vw] lg:max-h-[450px]  flex justify-center items-center absolute top-1/2 right-6 md:right-28 -translate-y-1/2 rounded-lg overflow-hidden">
            <Image
              src="/images/s4.png"
              alt="Hero"
              fill
        ...
        <div className="w-full blockbox flex items-center bg-[#f9dee4] px-5 py-3 xl:px-20 xl:py-10 relative rounded-lg shadow-lg shadow-[#4d0622]">
          <div className="flex flex-col">
            ...
            <div className="flex items-end w-full">
              <p className="text-black pt-2 md:pt-4 xl:pt-6 text-[10px] md:text-xl xl:text-2xl hover:underline cursor-pointer hover:text-[#C81059]">
                Checkout feautres and editorial <br /> work in digital magazines.
              </p>
              {/* <FaExternalLinkAlt className="text-2xl"/> */}
            </div>
          </div>
          <div className="w-[35vw] max-h-[180px] md:max-h-[250px] md:h-[30vw] md:w-[30vw] h-[38vw] lg:h-[30vw] lg:max-h-[450px]  flex justify-center items-center absolute top-1/2 right-6 md:right-28 -translate-y-1/2 rounded-lg overflow-hidden">
            <Image
              src="/images/muse.png"
              alt="Hero"
              fill
